        ...
        -->
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark navbar-dark sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.projects.index' ? 'bg-secondary' : '' }}"
                                    ...
                                    <i class="fa-solid fa-trash fa-lg fa-fw"></i> Canceled Projects
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul class="nav flex-column mt-5">
                            <li class="nav-item">
                                <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.types.index' ? 'bg-secondary' : '' }}"
                                    ...
                                    <i class="fa-solid fa-newspaper fa-lg fa-fw"></i> Type
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul class="nav flex-column mt-5">
                            <li class="nav-item">
                                <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.tecnologies.index' ? 'bg-secondary' : '' }}"
                                    href="{{ route('admin.tecnologies.index') }}">
                                    <i class="fa-solid fa-microchip fa-lg fa-fw"></i> Tecnology
                                </a>
                            </li>
                        </ul>
